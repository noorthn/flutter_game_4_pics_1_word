...
class LevelCount extends StatelessWidget {
  final num level;
        ...
        children: [
          Container(
              ...
              child: Container(
                ...
                child: Center(child: Text('$level', style: const TextStyle(color: Colors.black))),
              ),
          ),
          ...
          InkWell(
              child: Container(
                ...
                child: SvgPicture.asset('assets/svg/medal-star.svg', color: Colors.white, height: 18,)
              ),
                onTap: (){},
          ),
        ]
